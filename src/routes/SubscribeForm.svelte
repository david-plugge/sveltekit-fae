<script lang="ts">
	import { fae } from '../actions/fae.js';

	const form = fae.newsletter.subscribe.createForm();
</script>
...
>
	...
	<button
		...
		type="submit"
		class="bg-blue-600 font-semibold px-4 py-2 hover:bg-blue-700 transition-colors"
	>
		Subscribe
	</button>
</form>
